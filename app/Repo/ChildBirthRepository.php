...
class ChildBirthRepository implements IChildBirth
{

    private function getReportDetail($data)
    {
    ...
    public function getAnnualReport($year)
    {
        ...
        $reportDetail = $this->getReportDetail($baseData);
        ...
        $finalReport = ['total_mother' => $totalMother, 'average_gestational_age' => $averageGestationalAge, ...$reportDetail,  'maternal_age_group' => $motherAgeList];
